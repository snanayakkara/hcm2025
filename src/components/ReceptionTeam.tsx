    ...
    <section id="reception-team" className="py-32 bg-gradient-to-br from-cream-50 via-white to-primary-50/20" ref={sectionRef}>
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
        ...
        <div className={`mb-20 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <div className="bg-white/80 backdrop-blur-sm rounded-3xl shadow-xl overflow-hidden border-2 border-primary-200/50 hover:shadow-2xl transition-all duration-700">
            ...
            <div className="grid lg:grid-cols-3 gap-8 p-8">
              {/* Manager Image */}
              <div className={`relative overflow-hidden rounded-2xl bg-gradient-to-br ${practiceManager.color}`}>
                <img
        ...
        {/* Team Statistics */}
        <div className={`bg-white/80 backdrop-blur-sm rounded-3xl shadow-lg p-12 transition-all duration-1000 delay-600 border border-secondary-200/50 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="grid grid-cols-2 gap-6">
              <div className="bg-gradient-to-br from-primary-100 to-accent-100 p-6 rounded-2xl text-center">
                <div className="text-3xl font-bold text-primary-600">9</div>
                <div className="text-sm text-secondary-600">Team Members</div>
              </div>
              <div className="bg-gradient-to-br from-sage-100 to-primary-100 p-6 rounded-2xl text-center">
                <div className="text-3xl font-bold text-sage-600">4</div>
                <div className="text-sm text-secondary-600">Locations Supported</div>
              </div>
              <div className="bg-gradient-to-br from-accent-100 to-cream-100 p-6 rounded-2xl text-center">
              ...
              <div className="bg-gradient-to-br from-cream-100 to-primary-100 p-6 rounded-2xl text-center">
                <div className="text-3xl font-bold text-cream-600">24/7</div>
        ...
        <div className={`mt-16 bg-primary-500 rounded-3xl p-12 text-center transition-all duration-1000 delay-800 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            ...
            <button className="border-2 border-white text-white px-10 py-4 rounded-2xl hover:bg-white hover:text-primary-600 transition-all duration-200 font-semibold text-lg transform hover:scale-105">
              Book Online
            </button>
          </div>
        </div>
