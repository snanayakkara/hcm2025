    ...
    <>
      ...
      >
        <motion.button
          ...
          className="bg-gradient-to-r from-emerald-500 to-teal-500 text-white px-4 py-3 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 flex items-center space-x-2 group"
          whileHover={{ 
            scale: 1.05,
        ...
        >
          ...
          <span className="font-semibold text-sm">Join Telehealth Call</span>
          <motion.div
              ...
              {isMenuOpen && (
                ...
                >
                  <nav className="py-4 space-y-1">
                    ...
                    {/* Mobile Telehealth Button */}
                    <motion.button
                      onClick={handleTelehealthClick}
                      className="w-full flex items-center justify-center space-x-2 bg-gradient-to-r from-emerald-500 to-teal-500 text-white px-4 py-3 rounded-lg font-semibold shadow-sm mt-2"
