...
export const IntakeSchema = z.object({
  ...
  testsYear: z.string().optional(),
  // Individual test date/location fields
  echoLocation: z.string().optional(),
  echoDate: z.string().optional(),
  holterLocation: z.string().optional(),
  holterDate: z.string().optional(),
  angioLocation: z.string().optional(),
  angioDate: z.string().optional(),
  surgeryLocation: z.string().optional(),
