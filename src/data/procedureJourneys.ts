...
export const procedureJourneys: ProcedureJourneys = {
  ...
  angiogram_pci: {
    ...
    summary: 'Diagnostic procedure to visualise coronary arteries using contrast dye, with potential for immediate treatment (angioplasty/stenting) if blockages are found.',
    needToKnow: [
    ...
    steps: [
      ...
      },
      {
        ...
        description: "Contrast injection through cardiac catheter to visualise coronary arteries and identify blockages.",
        icon: () => React.createElement(Activity, { className: "w-5 h-5" }),
      ...
      },
      {
        ...
        description: "Careful observation for complications and medication optimisation before discharge.",
  ...
  mteer: {
    ...
    steps: [
      ...
      },
      {
        ...
        description: "Regular monitoring to assess durability of repair and optimise heart failure management.",
        icon: () => React.createElement(CheckCircle, { className: "w-5 h-5" }),
        duration: "Lifelong",
        details: [
  ...
  ctca: {
    ...
    summary: 'High-resolution CT scan with contrast to visualise coronary arteries and assess for blockages without invasive catheterisation.',
    needToKnow: [
    ...
    steps: [
      ...
      },
      {
        ...
        description: "High-resolution CT scanning with contrast to visualise coronary arteries and assess for blockages.",
        icon: () => React.createElement(Activity, { className: "w-5 h-5" }),
        duration: "15-30 minutes",
        details: [
  ...
  pyp_scan: {
    ...
    summary: 'Specialised nuclear imaging study to detect and quantify cardiac amyloid deposits using radiotracer technology.',
    needToKnow: [
    ...
    steps: [
      {
        ...
        description: "Clinical assessment and preparation for specialised nuclear cardiac imaging study.",
        icon: () => React.createElement(FileText, { className: "w-5 h-5" }),
        duration: "30 minutes",
        details: [
      ...
      },
      {
        ...
        description: "Specialised nuclear imaging to detect and quantify cardiac amyloid deposits.",
        icon: () => React.createElement(Monitor, { className: "w-5 h-5" }),
        duration: "45 minutes",
        details: [
      ...
      },
      {
        ...
        description: "Specialised interpretation to determine presence and extent of cardiac amyloidosis.",
        icon: () => React.createElement(CheckCircle, { className: "w-5 h-5" }),
        duration: "1-2 days",
        details: [
  ...
  abpm: {
    ...
    description: 'Continuous blood pressure monitoring over 24 hours during normal daily activities',
    ...
    steps: [
      {
        ...
        description: "Initial appointment to fit the ambulatory blood pressure monitor and provide comprehensive instructions.",
        icon: () => React.createElement(Monitor, { className: "w-5 h-5" }),
      ...
      },
      {
        ...
        description: "24-hour period of continuous blood pressure monitoring during normal daily activities.",
        icon: () => React.createElement(Clock, { className: "w-5 h-5" }),
        duration: "24 hours",
        details: [
      ...
      },
      {
        ...
        title: "Device Return",
        subtitle: "Monitor removal and data download",
        description: "Return appointment to remove the monitoring device and download recorded data.",
        icon: () => React.createElement(UserCheck, { className: "w-5 h-5" }),
        duration: "10-15 minutes",
        details: [
      ...
      },
      {
        ...
        description: "Detailed analysis of 24-hour blood pressure patterns with clinical interpretation and treatment recommendations.",
        icon: () => React.createElement(FileText, { className: "w-5 h-5" }),
        duration: "2-3 days",
        details: [
  ...
  asd_closure: {
    ...
    summary: 'Minimally invasive procedure to close an abnormal opening between the heart\'s upper chambers using a specialised closure device.',
    needToKnow: [
      'Day procedure or overnight stay',
      'Performed via catheter through leg vein',
  ...
  icd: {
    ...
    steps: [
      ...
      },
      {
        ...
        description: "Recovery period with device programming optimisation and patient education.",
        icon: () => React.createElement(Monitor, { className: "w-5 h-5" }),
        duration: "4-24 hours",
        details: [
          "Wound care and infection prevention",
  ...
  eps: {
    ...
    type: 'test',
    image: '/images/angio.png',
    summary: 'Specialised catheter-based test to evaluate the heart\'s electrical system, diagnose arrhythmias, and guide treatment decisions.',
    needToKnow: [
    ...
    steps: [
      ...
      },
      {
        ...
        description: "Placement of specialised catheters to map the heart\'s electrical system.",
        icon: () => React.createElement(Activity, { className: "w-5 h-5" }),
        duration: "30-60 minutes",
        details: [
  ...
  loop_recorder: {
    ...
    description: 'Small device implantation for long-term heart rhythm monitoring',
    color: 'from-blue-500 to-teal-500',
    category: 'monitoring',
    type: 'procedure',
    image: '/images/loop.png',
    summary: 'A minimally invasive procedure to implant a tiny device under the skin to continuously monitor your heart rhythm for extended periods, detecting irregularities.',
    needToKnow: [
    ...
    steps: [
      {
        ...
        description: "Assessment of rhythm monitoring needs and selection of the appropriate loop recorder device.",
        icon: () => React.createElement(Activity, { className: "w-5 h-5" }),
        duration: "1-7 days",
        details: [
      ...
      },
      {
        ...
        description: "Implantation of the loop recorder under the skin using local anaesthetic and a small incision.",
        icon: () => React.createElement(Heart, { className: "w-5 h-5" }),
        duration: "15-30 minutes",
        details: [
      ...
      },
      {
        ...
        description: "Short observation period and activation of remote device monitoring.",
        icon: () => React.createElement(Monitor, { className: "w-5 h-5" }),
        duration: "30-60 minutes",
        details: [
      ...
      },
      {
        ...
        description: "Ongoing remote monitoring and periodic review of heart rhythm data.",
        icon: () => React.createElement(CheckCircle, { className: "w-5 h-5" }),
  ...
  surgical_avr: {
    ...
    summary: 'An open-heart surgical procedure to replace a diseased aortic valve with a mechanical or tissue prosthesis.',
    needToKnow: [
    ...
    steps: [
      {
        ...
        description: "Detailed evaluation to assess surgical risk and plan the optimal valve replacement strategy.",
        icon: () => React.createElement(Clipboard, { className: "w-5 h-5" }),
        duration: "1-2 weeks",
        details: [
      ...
      },
      {
        ...
        description: "Replacement of the diseased aortic valve with a mechanical or tissue prosthesis under general anaesthesia.",
        icon: () => React.createElement(Heart, { className: "w-5 h-5" }),
        duration: "3-5 hours",
        details: [
      ...
      },
      {
        ...
        description: "Initial recovery in intensive care for close monitoring and stabilization.",
        icon: () => React.createElement(Monitor, { className: "w-5 h-5" }),
        duration: "1-2 days",
        details: [
      ...
      },
      {
        ...
        description: "Continued recovery on the ward with physiotherapy and education for home care.",
        icon: () => React.createElement(UserCheck, { className: "w-5 h-5" }),
        duration: "3-5 days",
        details: [
          "Progressive mobilization and physiotherapy",
      ...
      },
      {
        ...
        description: "Regular follow-up for valve function, medication management, and lifestyle optimization.",
        icon: () => React.createElement(Calendar, { className: "w-5 h-5" }),
        duration: "Lifelong",
        details: [
  ...
  surgical_mvr: {
    ...
    description: 'Open-heart or minimally invasive surgery to replace the mitral valve',
    color: 'from-primary-500 to-sage-500',
    category: 'surgery',
    type: 'procedure',
    image: '/images/minimitral.png',
    summary: 'Replacement of a severely damaged mitral valve with a mechanical or biological prosthesis through open-heart or minimally invasive techniques.',
    needToKnow: [
    ...
    steps: [
      {
        ...
        description: "Comprehensive assessment including imaging and anaesthetic review to determine best surgical approach.",
        icon: () => React.createElement(Clipboard, { className: "w-5 h-5" }),
        duration: "1-2 weeks",
        details: [
      ...
      },
      {
        ...
        description: "Replacement of the mitral valve with a prosthesis using the most appropriate surgical technique.",
        icon: () => React.createElement(Heart, { className: "w-5 h-5" }),
        duration: "3-5 hours",
        details: [
          "General anaesthesia and heart-lung bypass",
      ...
      },
      {
        ...
        description: "Immediate postoperative recovery in intensive care for close monitoring and stabilization.",
        icon: () => React.createElement(Monitor, { className: "w-5 h-5" }),
        duration: "1-2 days",
        details: [
          "Mechanical ventilation and gradual weaning",
      ...
      },
      {
        ...
        description: "Continued recovery with physiotherapy and education to support return home.",
        icon: () => React.createElement(UserCheck, { className: "w-5 h-5" }),
        duration: "3-5 days",
        details: [
          "Progressive mobilization and physiotherapy",
      ...
      },
      {
        ...
        description: "Ongoing care for valve surveillance, anticoagulation, and lifestyle optimization.",
        icon: () => React.createElement(FileText, { className: "w-5 h-5" }),
  ...
  ross_procedure: {
    name: 'Ross Procedure',
    description: 'Complex aortic valve replacement surgery using patient\'s own pulmonary valve',
    color: 'from-accent-500 to-primary-500',
    category: 'surgery',
    type: 'procedure',
    image: '/images/ross.png',
    summary: 'Specialized surgery to replace a diseased aortic valve using your own pulmonary valve, while a donor valve replaces the pulmonary valve.',
    needToKnow: [
      'General anaesthesia and heart-lung bypass',
    ...
    steps: [
      {
        ...
        description: "Comprehensive cardiac and surgical evaluation to ensure suitability for the Ross procedure.",
        icon: () => React.createElement(Clipboard, { className: "w-5 h-5" }),
        duration: "1-2 weeks",
        details: [
      ...
      },
      {
        ...
        description: "Replacement of the aortic valve with the patient's own pulmonary valve, and pulmonary valve replaced with a donor valve.",
        icon: () => React.createElement(Heart, { className: "w-5 h-5" }),
        duration: "5-8 hours",
        details: [
          "General anaesthesia and heart-lung bypass",
      ...
      },
      {
        ...
        description: "Immediate recovery in intensive care for stabilization and early complication detection.",
        icon: () => React.createElement(Monitor, { className: "w-5 h-5" }),
        duration: "2-3 days",
        details: [
      ...
      },
      {
        ...
        description: "Progressive recovery on the ward with physiotherapy and education for home care.",
        icon: () => React.createElement(UserCheck, { className: "w-5 h-5" }),
        duration: "5-7 days",
        details: [
      ...
      },
      {
        ...
        description: "Regular follow-up to monitor both aortic and pulmonary valve function and overall heart health.",
        icon: () => React.createElement(Calendar, { className: "w-5 h-5" }),
        duration: "Lifelong",
        details: [
  ...
  triclip_repair: {
    ...
    summary: 'A minimally invasive catheter-based procedure using the TriClip device to repair the tricuspid valve and reduce tricuspid regurgitation.',
    needToKnow: [
    ...
    steps: [
      {
        ...
        description: "Comprehensive assessment by heart team and advanced imaging to confirm suitability for TriClip repair.",
        icon: () => React.createElement(Heart, { className: "w-5 h-5" }),
        duration: "1-2 weeks",
        details: [
      ...
      },
      {
        ...
        description: "Percutaneous placement of TriClip device under imaging guidance to reduce tricuspid regurgitation.",
        icon: () => React.createElement(Activity, { className: "w-5 h-5" }),
        duration: "1-3 hours",
        details: [
          "General anaesthesia or deep sedation",
      ...
      },
      {
        ...
        description: "Observation and monitoring after the procedure to ensure stability and recovery.",
        icon: () => React.createElement(Monitor, { className: "w-5 h-5" }),
        duration: "1-3 days",
        details: [
      ...
      },
      {
        ...
        description: "Regular follow-up with echocardiography to assess device function and heart status.",
        icon: () => React.createElement(Calendar, { className: "w-5 h-5" }),
        duration: "Lifelong",
        details: [
  ...
  rotational_atherectomy: {
    ...
    summary: 'A procedure utilizing a rotating burr device to remove calcified plaque from coronary arteries, facilitating stent placement and blood flow restoration.',
    needToKnow: [
      'Procedure duration: 1-2 hours',
    ...
    steps: [
      {
        ...
        description: "Detailed evaluation and planning to determine need and suitability for rotational atherectomy.",
        icon: () => React.createElement(Search, { className: "w-5 h-5" }),
        duration: "1-7 days",
        details: [
      ...
      },
      {
        ...
        description: "Use of a rotating burr to remove hardened plaque and prepare the artery for stenting.",
        icon: () => React.createElement(Activity, { className: "w-5 h-5" }),
        duration: "1-2 hours",
        details: [
          "Local anaesthetic and sedation",
      ...
      },
      {
        ...
        description: "Observation and monitoring for complications following the procedure.",
        icon: () => React.createElement(Monitor, { className: "w-5 h-5" }),
        duration: "4-24 hours",
        details: [
      ...
      },
      {
        ...
        description: "Regular follow-up to monitor stent function and optimize cardiovascular health.",
        icon: () => React.createElement(CheckCircle, { className: "w-5 h-5" }),
        duration: "Lifelong",
        details: [
  ...
  ivus: {
    ...
    summary: 'Intravascular ultrasound (IVUS) procedure using a specialized catheter (e.g., Boston Scientific AVVIGO system) to visualize the inside of coronary arteries and optimize stent placement.',
    needToKnow: [
    ...
    steps: [
      {
        ...
        description: "Patient preparation and vascular access for IVUS imaging, typically during coronary angiography.",
        icon: () => React.createElement(Clipboard, { className: "w-5 h-5" }),
      ...
      },
      {
        ...
        description: "Insertion of IVUS catheter into coronary artery and acquisition of detailed vessel images.",
        icon: () => React.createElement(Activity, { className: "w-5 h-5" }),
        duration: "15-20 minutes",
        details: [
      ...
      },
      {
        ...
        description: "Safe removal of IVUS catheter and monitoring for immediate complications.",
        icon: () => React.createElement(Monitor, { className: "w-5 h-5" }),
      ...
      },
      {
        ...
        description: "Utilization of IVUS findings to guide and optimize coronary stent placement and long-term outcomes.",
        icon: () => React.createElement(CheckCircle, { className: "w-5 h-5" }),
